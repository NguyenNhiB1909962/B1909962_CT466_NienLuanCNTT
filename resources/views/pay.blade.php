    ...
    <section id="cart_items">
        <div class="container" style="font-size: 18px">
            ...
            <div class="payment-options">
                <form action="{{URL::to('/order_pro')}}" method="POST">
                    @csrf
                    <span>
                        <label><input name="pay_option" value="1" type="checkbox"> Payment on delivery</label>
                    </span>
                    <br>
                    <hr>
                    <input type="submit" value="Order" name="send" class="btn btn-default" style="font-size: 15px; margin-bottom: 10px; background-color: forestgreen; color: aliceblue">
                </form>
            </div>
        </div>
    </section> 
