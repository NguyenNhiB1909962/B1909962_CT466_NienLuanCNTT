					...
					<div class="col-sm-8">
                        <div style="font-size: 20px">
							<ul class="nav justify-content-end">
								<li><a href="cart" class="text-dark"><i class="fa fa-shopping-cart"></i> Cart</a></li>
								<li><a href="login" class="text-dark"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
