        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <a href="{{URL::to('/category_pro/'.$cate->category_id)}}" style="text-decoration: none; color: black; display: block;">{{$cate->category_name}}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div>
                                <ul class="nav nav-pills nav-stacked list-group" style="list-style: none; font-size: 15px; text-align: left">
                                    @foreach ($brand as $key => $bra)
                                        <li style="border-bottom: 1px solid #e8e8e8"><a href="{{URL::to('/brand_pro/'.$bra->brand_id)}}" style="text-decoration: none; color: black; display: block;">{{$bra->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-sm-9 padding-right">
                    <div>
                        @foreach ($cate_name as $key => $cate_by_name)
                            <h2 style="color: blueviolet; text-align: center"><b>{{$cate_by_name->category_name}}</b></h2>
                        @endforeach
                        @foreach ($cate_id as $key => $pro)
