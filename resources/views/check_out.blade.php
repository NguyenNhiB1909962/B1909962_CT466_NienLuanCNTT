                            ...
                            <div class="form-one">
                                <form action="{{URL::to('/checkout')}}" method="POST">
                                    ...
                                    <div class="form-group" style="font-size: 18px">
                                        <input type="text" placeholder="Name " name="shopping_cart_name" style="width: 100%; margin-bottom: 10px" value="{{old('shopping_cart_name')}}">
                                        <br>
                                        <span class="text-danger" style="font-size: 18px">@error('shopping_cart_name') {{$message}} @enderror</span>
                                    </div>
                                    <div class="form-group" style="font-size: 18px">
                                        <input type="text" placeholder="Email " name="shopping_cart_email" style="width: 100%; margin-bottom: 10px" value="{{old('shopping_cart_email')}}">
                                        <br>
                                        <span class="text-danger" style="font-size: 18px">@error('shopping_cart_email') {{$message}} @enderror</span>
                                    </div>

                                    <div class="form-group" style="font-size: 18px">
                                        <input type="text" placeholder="Address " name="shopping_cart_address" style="width: 100%; margin-bottom: 10px" value="{{old('shopping_cart_address')}}">
                                        <br>
                                        <span class="text-danger" style="font-size: 18px">@error('shopping_cart_address') {{$message}} @enderror</span>
                                    </div>

                                    <div class="form-group" style="font-size: 18px">
                                        <input type="text" placeholder="Phone " name="shopping_cart_phone" style="width: 100%; margin-bottom: 10px" value="{{old('shopping_cart_phone')}}">
                                        <br>
                                        <span class="text-danger" style="font-size: 18px">@error('shopping_cart_phone') {{$message}} @enderror</span>
                                    </div>
                                    
                                    <textarea placeholder="Notes about your order" name="shopping_cart_notes" rows="5" style="width: 100%; margin-bottom: 10px"></textarea>
                                    
                                    <input type="submit" value="Send" name="send" class="btn btn-default" style="font-size: 15px; width: 75%; margin-bottom: 10px; background-color: forestgreen; color: aliceblue">
                                </form>
                            </div>
                        </div>
                    </div>
